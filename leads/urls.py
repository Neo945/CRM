...
urlpatterns = [
    ...
    path('lead/not/moved/job/<int:jobid>', get_all_unchecked_leads_by_job,name='get_all_unchecked_leads_by_job'),
    ...
    path('market/moved/job/<int:jobid>', get_checked_marketing_leads_by_job, name='get_checked_marketing_leads_by_job'),
    path('market/not/moved/job/<int:jobid>', get_unchecked_marketing_leads_by_job, name='get_unchecked_marketing_leads_by_job'),
    ...
    path('sales/moved/', get_all_checked_sales_leads, name='get_all_checked_sales_leads'),
    path('sales/not/moved/', get_all_unchecked_sales_leads, name='get_all_unchecked_sales_leads'),
    path('sales/moved/job/<int:jobid>', get_checked_sales_leads_by_job, name='get_checked_sales_leads_by_job'),
    path('sales/not/moved/job/<int:jobid>', get_unchecked_sales_leads_by_job, name='get_unchecked_sales_leads_by_job'),
    ...
    path('presales/moved/', get_all_checked_presales_leads, name='get_all_checked_presales_leads'),
    path('presales/not/moved/', get_all_unchecked_presales_leads, name='get_all_unchecked_presales_leads'),
    path('presales/moved/job/<int:jobid>', get_checked_presales_leads_by_job, name='get_checked_presales_leads_by_job'),
    path('presales/not/moved/job/<int:jobid>', get_unchecked_presales_leads_by_job, name='get_unchecked_presales_leads_by_job'),

    path('create/operation/<int:presalesleadid>', create_operation_leads, name='create_operation_leads'),
    path('create/operation/', create_all_operations_leads, name='create_all_operations_leads'),
    ...
    path('operation/moved/', get_all_checked_operations_leads, name='get_all_checked_operations_leads'),
    path('operation/not/moved/', get_all_unchecked_operations_leads, name='get_all_unchecked_operations_leads'),
    path('operation/moved/job/<int:jobid>', get_checked_operations_leads_by_job, name='get_checked_operations_leads_by_job'),
    path('operation/not/moved/job/<int:jobid>', get_unchecked_operations_leads_by_job, name='get_unchecked_operations_leads_by_job'),
