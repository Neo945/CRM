...
urlpatterns = [
    ...
    path('operation/moved/', get_all_checked_operations_leads, name='get_all_checked_marketing_leads'),
    path('operation/not/moved/', get_all_unchecked_operations_leads, name='get_all_unchecked_marketing_leads'),
    path('operation/moved/job/<int:jobid>', get_checked_operations_leads_by_job, name='get_marketing_leads_by_job'),
    path('operation/not/moved/job/<int:jobid>', get_unchecked_operations_leads_by_job, name='get_marketing_leads_by_job'),
