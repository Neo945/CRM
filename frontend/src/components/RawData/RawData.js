...
function RawData(props){
  ...
  const validate = () => {
    ...
    if (emailError || nameError || websiteError || companyError ||
      mobileError || linkedinError || streetError || cityError || stateError || pincodeError ||
      countryError || cidError ) {
      // lcpnError || lcdError || lemailError || lmobileError ||
      // lwebsiteError || logidError  
      setState(
        {
          ...state,
          emailError, nameError, websiteError, companyError,
          mobileError, linkedinError, streetError, cityError, stateError, 
          cidError, pincodeError, countryError
          ...
          <div className='container1'>
            ...
            <form onSubmit={handleSubmit} className='rawform'>
              ...
              <div className='wrapper'>
                ...
                <div className='box'>
                  <input type="text" placeholder="Enter Customer ID" name="cid" id="cid"
                    value={state.cid}
                    onChange={e => change(e)}
                  ></input>
                ...
                <div className='box'>
                  <input type="text" placeholder="Enter Customer's Name" name="cname" id="cname"
                    value={state.cname}
                    onChange={e => change(e)}
                  ></input>
                  <div style={{ fontSize: 12, color: "red" }}>
              ...
              <div className='wrapper'>
                ...
                <div className='box'>
                  <input type="email" placeholder="Enter Customer Email ID" name="email" id="email"
                    value={state.email}
                    onChange={e => change(e)}
                  ></input>
                  <div style={{ fontSize: 12, color: "red" }}>
                ...
                <div className='box'>
                  <input type="number" placeholder="Enter Customer Mobile Number" name="mobile" id="mobile"
                    value={state.mobile}
                    onChange={e => change(e)}
                  ></input>
                  <div style={{ fontSize: 12, color: "red" }}>
              ...
              <div className='wrapper'>
                ...
                <div className='box'>
                  <input type="text" placeholder="Enter Customer Website URL" name="website" id="website"
                    value={state.website}
                    onChange={e => change(e)}
                  ></input>
                  <div style={{ fontSize: 12, color: "red" }}>
                ...
                <div className='box'>
                  <input type="text" placeholder="Enter LinkedIn ID" name="lid" id="lid"
                    value={state.lid}
                    onChange={e => change(e)}
                  ></input>
                  <div style={{ fontSize: 12, color: "red" }}>
              ...
              <div className='wrapper'>
                ...
                <div className='box'>
                  <input type="number" placeholder="Enter Pincode" name="pincode" id="pincode"
                    value={state.pincode}
                    onChange={e => change(e)}
                  ></input>
                  <div style={{ fontSize: 12, color: "red" }}>
              ...
              <div className='wrapper'>
                ...
                <div className='box'>
                  <input type="text" placeholder="Enter Country's Name" name="country" id="country"
                    value={state.country}
                    onChange={e => change(e)}
                  ></input>
                  <div style={{ fontSize: 12, color: "red" }}>
